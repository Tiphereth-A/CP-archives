...
inline void solve(int t_) {
    read_var_(int, n);
    read_container_(vector<Line2>, vl, n);
    vl.push_back(Line2(0, 0, 10000, 0));
    vl.push_back(Line2(10000, 0, 10000, 10000));
    vl.push_back(Line2(10000, 10000, 0, 10000));
    vl.push_back(Line2(0, 10000, 0, 0));
    cout << ins_hP(vl).area() << '\n';
}
int main() {
