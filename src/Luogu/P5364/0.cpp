...
const i64 tb[11][11] = {
  ...
  {75, 52, 18, 4},
  {541, 375, 130, 30, 5},
  {4683, 3246, 1125, 260, 45, 6},
  {47293, 32781, 11361, 2625, 455, 63, 7},
  {545835, 378344, 131124, 30296, 5250, 728, 84, 8},
  {7087261, 4912515, 1702548, 393372, 68166, 9450, 1092, 108, 9},
  {102247563,
   70872610,
   24562575,
   5675160,
...
auto solve([[maybe_unused]] int t_ = 0) -> void {
  i64 n, k;
  cin >> n >> k;
  i64 _ = (qpow(2, n, MOD) + MOD - 1) % MOD * tb[k][0] % MOD;
  n %= MOD;
  i64 __ = 0;
  for_(i, 1, k - 1, p = 1) {
    (__ += tb[k][i] * p % MOD) %= MOD;
