  ...
  do {
    ...
    for_(i, 4, vl.size() - 1) {
      ...
      for_(j, 0, i - 1) {
        ...
        if (!is_less(dist_PP(vl[i].l, p), dist_PP(vl[i].r, p)) &&
            is_less(dist_PP(vl[i].l, p), dist_PP(vl[i].l, l)))
          l = p;
        if (!is_less(dist_PP(vl[i].r, p), dist_PP(vl[i].l, p)) &&
            is_less(dist_PP(vl[i].r, p), dist_PP(vl[i].r, r)))
          r = p;
      }
      now_ans += dist_PP(l, r);
    }
