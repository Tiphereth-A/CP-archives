...
template <typename _T, const char _str_begin, const char _str_end, const std::size_t _N, const bool _clear>
class _ACAM_Base {
  protected:
    struct ACAM_t {
...
template <typename _T = std::ptrdiff_t, const char _str_begin = 'a', const char _str_end = 'z' + 1, const std::size_t _N = N, const bool _clear = false>
