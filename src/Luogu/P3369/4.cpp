...
public:
  ...
  size_t qrank_by_val(Tp const &val) { return rank_(root, val); }
  Tp qval_by_rank(size_t rk) { return val_(root, rk); }
...
int main() {
  ...
  while (t--) {
    ...
    switch (mode) {
      ...
      case 3: cout << tr.qrank_by_val(num) << '\n'; break;
      case 4: cout << tr.qval_by_rank(num) << '\n'; break;
