...
constexpr bool is_less(data_t lhs, data_t rhs) { return is_negative(lhs - rhs) & 2; }
...
struct Point2 {
    ...
    friend constexpr self polar(data_t r, data_t theta) { return self{r * cos(theta), r * sin(theta)}; }
