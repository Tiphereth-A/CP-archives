...
inline void main(pointer a, pointer b, size_type n) {
...
int main() {
    ...
    u64 x, y;
    _for(i, 1u, n - 1) {
        x = ((b_head == b_tail) || (a_head < n && a[a_head] < b[b_head])) ? a[a_head++] : b[b_head++];
        y = ((b_head == b_tail) || (a_head < n && a[a_head] < b[b_head])) ? a[a_head++] : b[b_head++];
        b[b_tail++] = x + y;
        ans += x + y;
    }
    cout << ans;
