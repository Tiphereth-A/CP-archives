...
int a[N];
i64 sum[N];
RMQ_ST<N, int> max_a([](const size_t i) { return i; }, [](const int l, const int r) { return a[l] < a[r] ? r : l; });
RMQ_ST<N, i64> min_sum([](const size_t i) { return sum[i]; }, [](const i64 l, const i64 r) { return min(l, r); });
RMQ_ST<N, i64> max_sum([](const size_t i) { return sum[i]; }, [](const i64 l, const i64 r) { return max(l, r); });
